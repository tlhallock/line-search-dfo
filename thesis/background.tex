...
COBYLA \cite{pub.1046127469} was one of the first model-based approaches for solving bound constrained black-box problems.
...
A two-phased, feasibility and optimization approach that handles non-linear constraints and infeasible starting points is developed within \cite{BAJAJ2018306}.
...
The authors avoid possible infeasible evaluations by altering the objective function to include a projection onto an $L_1$ ball.
...
The algorithm presented within \cite{Conejo2015} is also a model-based trust region method, and it ensures each iterate is feasible,
