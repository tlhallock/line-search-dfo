...
\begin{itemize}
\item \textbf{The Outer Trust region} is denoted by $\outertrk$.
\item \textbf{The Sample Region} is denoted by $\sampletrk$ and is used as to constrain sample points to ensure their feasibility.
\item \textbf{The Search Region} is denoted by $\searchtrk$ and is used within the trust region subproblem.
\end{itemize}
