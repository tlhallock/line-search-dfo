...
where $\hat{\Lambda} = \Lambda \sqrt{p+1}\max\{1, \Delta^2\}$.
\end{theorem}
...
& \le \sqrt{p+1} \norm{M^{-1}}_2 \norm{\bar{\phi}(x)}_{\infty} \\
& \le \Lambda \sqrt{p+1} \max\left\{1, |x_1|, \ldots,|x_n|, \frac 1 2 x_1^2/2, \ldots, \frac 1 2 x_n^2, x_1x_2, \ldots, x_{n-1}x_n\right\}\\
& \le \Lambda \sqrt{p+1}  \max\{1, \Delta^2\} = \hat{\Lambda}.
\end{align*}
