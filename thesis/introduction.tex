...
\sbnote{Can we find an example of a unrelaxable constraint?}   
...
constraints.  \sbnote{It doesn't make sense to call linear constraints partially-quantifiable.
The issue is that the objective function can't be evaluated outside the feasible region.}
