...
Following the taxonomy in \cite{ledigabel2015taxonomy}, these constraints are called {\em unrelaxable}.
...
\|x\|_1 = \sum_{i = 1}^n |x_i|.
\end{align*}
When a norm is presented without a subscript, it is presumed to be the $2$ norm: $\|x\| = \|x\|_2$ for any $x \in \Rn$.
