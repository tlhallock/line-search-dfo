...
Observe that by using an $L_{\infty}$-ball instead of an $L_2$-ball, the trust regions are polytopes.  We therefore call this the {\em polyhedral trust region approach}.
While this method is perhaps more intuitive than the first approach, it is not immediately clear how to construct a well-poised sample set over the polyhedral region.
We present one method for doing this.
