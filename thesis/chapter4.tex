...
\sbnote{I like your choice to call the following two results corollaries.   But then, the proofs should be based on the theorem rather than from the lemmas leading up to the theorem. }
\begin{corollary}
