...
\end{array}
\end{align*}
Just as in \cref{linear_accuracy_is_satisfied}, after using \cref{model_improving_algorithm} and to choose sample points, we know by \cref{set_is_poised} and \cref{3_16_replacement} that there
