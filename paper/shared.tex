...
In either case, work to find a point satisfisfying \cref{efficiency} and 
\begin{equation}
\label{accuracy}
...
One simple approach to handle partially-quantifiable constraints is to maintaining the same trust region as the classical algorithm, but avoid letting points fall outside the feasible region within the model improvement algorithm \cref{model_improving_algorithm}.
...
In figure \cref{line_can_run}, the red line shows the line segments maintaining equidistance to their closest constraints.
