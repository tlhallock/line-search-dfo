...
\begin{itemize}
    ...
    \item The algorithm is as follows:
        \begin{itemize}
            \item Start with a polynomial $p$, a tolerance $\epsilon$, a set of infeasible points $I = \emptyset$, and feasible points $F$.
            \item Compute
            \begin{displaymath}
                \begin{array}{ccccc}
                    max_{s, v^{(i)}, b^{(i)}} & p(s)       &       &                               & \\
                               & v^T p      & \le   & 0                             & \forall n \in F, \quad \forall m \in F\\
                               & v^T n      & \ge   & \epsilon \Delta_k             & \forall n \in I \\
                               & \|v \|^2   & =     & 1                             & \forall n \in I \\
                               & v^T n      & \ge   & \epsilon                      & \forall n \in I \\
