...
\wik = \xk + \left(1 - \alpha\dk^{\frac 3 2}\right)\left(\zik - \xk\right) \\
...
\begin{theorem}
If $\dk < \epsilon$ and $z^{(i, k)} \in B_{\infty}(\xk, \dk))$, then
\begin{align*}
...
We can compute
\begin{align*}
\wik - \xk = \xk + \left(1 - \alpha \dk^{\frac 3 2 }\right)\left(\zik - \xk\right) - \xk 
= \left(1 - \alpha \dk^{\frac 3 2 }\right)\left(\zik - \xk\right) \\
= \left(1 - \alpha \dk^{\frac 3 2 }\right)\left(\xk - \frac{c_i(\xk)}{\|\gik\|^2}\gik - \xk\right) 
= \left(1 - \alpha \dk^{\frac 3 2 }\right)\frac{-c_i(\xk)}{\|\gik\|^2}\gik
\end{align*}
...
= c_i(\xk) + \left(\gik\right)^T\left(1 - \alpha \dk^{\frac 3 2 }\right)\frac{-c_i(\xk)}{\|\gik\|^2}\gik + M \left\|\left(1 - \alpha \dk^{\frac 3 2 }\right)\frac{-c_i(\xk)}{\|\gik\|^2}\gik\right\|^2  + \epsilon_g \dk^2\nu^T \left(\wik - \xk\right) \\
= c_i(\xk)\left[1 - \left(1 - \alpha \dk^{\frac 3 2 }\right)\right] + M \frac {c_i(\xk)^2}{\|\gik\|^2}\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 + \epsilon_g \dk^2\nu^T \left(\wik - \xk\right) \\
= \alpha \dk^{\frac 3 2 } c_i(\xk) + M \frac {c_i(\xk)^2}{\|\gik\|^2}\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 + \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right)\frac{-c_i(\xk)}{\|\gik\|^2}\nu^T\gik \\
\le \alpha \dk^{\frac 3 2 } c_i(\xk) + M \frac {c_i(\xk)^2}{\|\gik\|^2}\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 + \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right)\frac{-c_i(\xk)}{\|\gik\|} \\
\end{align*}
...
By choosing
\begin{align*}
\dk \le \left[\frac {g_{\text{low}} \beta} {2M\sqrt{n}\left(1 + \frac {L_g} M \right)} \right]^2 \\
\dk^{\frac 1 2} \le \frac {g_{\text{low}} \beta} {2M\sqrt{n}\left(1 + \frac {L_g} M \right)}  \\
\sqrt{n}\left(1 + \frac {L_g} M \right) \dk^{\frac 1 2} \le \frac 1 {2M} g_{\text{low}} \beta \\
\sqrt{n}\left(1 + \frac {L_g} M \right) \dk \le \frac 1 {2M} g_{\text{low}} \beta \dk^{\frac 1 2} \\
\sqrt{n} \dk \le -\frac 1 M \sqrt{n}\dk L_g + \frac 1 {2M} g_{\text{low}} \beta \dk^{\frac 1 2} \\
\end{align*}
we find that
...
t 
\le \sqrt{n} \dk 
\le -\frac 1 M \sqrt{n}\dk L_g + \frac 1 {2M} g_{\text{low}} \beta \dk^{\frac 1 2} \\
\le -\frac 1 M \sqrt{n}\dk L_g -\frac 1 M \nabla c_i(\xk)^Ts 
\Longrightarrow \sqrt{n}\dk L_g + \nabla c_i(\xk)^Ts + M t \le 0
\end{align*}
so that
\begin{align*}
c_i(y) = c_i(\wik + ts) \le c_i(\wik) + t\nabla c_i(\wik)^Ts + M t^2 \\
\le t \left(\nabla c_i(\wik)^Ts - \nabla c_i(\xk)^Ts + \nabla c_i(\xk)^Ts + M t\right) \\
\le t \left(L_g\|\wik - \xk\| + \nabla c_i(\xk)^Ts + M t\right) \\
\le t \left(\sqrt{n}\dk L_g + \nabla c_i(\xk)^Ts + M t\right) \le 0.
\end{align*}
