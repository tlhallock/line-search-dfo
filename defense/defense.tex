...
\begin{frame}{Example Problem}
	...
	\end{itemize}
% \begin{center}
% \includegraphics[width=50px]{images/hoffman_0.png}
% \includegraphics[width=50px]{images/hoffman_1.png}
% \includegraphics[width=50px]{images/hoffman_2.png}
% \includegraphics[width=50px]{images/hoffman_3.png}
% 
% 
% 
% 
% 
% \includegraphics[width=50px]{images/local_regularity.png}
% 
% \includegraphics[width=50px]{images/decreasing_regularity.png}
% \includegraphics[width=50px]{images/decreasing_regularity_2.png}
% 
% \includegraphics[width=50px]{images/classification.png}
% \end{center}
