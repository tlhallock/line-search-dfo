...
In unconstrained optimization, it is typical and natural that the sample trust region be centered at the current iterate.   Thus, much of the standard theory (see for example,   
