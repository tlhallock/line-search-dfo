...
% \color{red}
% \begin{align*}
% \left(u_{GC} - \xk\right) ^T\left(\nabla^2m_f^{(k)}\left(\xk\right)\right)\left(u_{GC} - \xk\right) 
% \end{align*}
% \color{black}
% 
% 
% 
% \begin{align*}
% \delta^2 \left(\hfb - 1\right)\left(1 + \sqrt{n}\right)^2 \le \frac 1 2 \kappa_f \kappa_{\chi} \min\left\{ \frac{\kappa_{\chi}}{\hfb}, 1 \right\} \\
% \delta^2 \le \frac{\kappa_f \kappa_{\chi}}{2\left(\hfb - 1\right)\left(1 + \sqrt{n}\right)^2} \min\left\{ \frac{\kappa_{\chi}}{\hfb}, 1 \right\} \\
% \delta \le \\
% \end{align*}
...
\begin{align*}
\|s_2 - s_1\|_\infty \le \frac{1}{1 - \epsilon\Gamma_0(A_1)}\|x_2 - x_1\| \le \frac{\epsilon\Gamma_0(A_1)}{1 - \epsilon\Gamma_0(A_1)}\left(1 + \|s_1\|_{\infty}\right) \le 4\epsilon\Gamma_0(A_1)\left(1 + \|s_1\|_{\infty}\right).
\end{align*}
...
We can once again use \cref{4_2} to choose a $y_1 \in P_1$ satisfying $\|x_1 ^{\star} - y_1\|_{\infty} \le c_{r_2}\epsilon$.
