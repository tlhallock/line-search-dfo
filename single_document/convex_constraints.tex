...
\begin{lemma}
\label{max_model_hessian_lemma}
Assume that \label{bounded_hessians_assumption} and \label{minangleassumption} hold and that $\dk \le \dsr$.
Then there exists a $\maxmodelhessian > 0$ such that 

\begin{align*}
\| \hk \| \le \maxmodelhessian \quad \forall x \in \Omega \\
\|\nabla^2  \| \le \maxmodelhessian \quad \forall x \in \Omega, \forall 1 \le i \le m
\end{align*}
