...
\begin{align}
\chik \ge \kappa_{\chi} \dk \label{sr_chi_big_enough}
\end{align}
and
\begin{align}
...
% \ge \kappa_f \kappa_{\chi}  \min\left\{ \frac{\kappa_{\chi}}{\hfb}, 1 \right\} \dk^2 - \delta \left\|\gk\right \|  \left|\left(u_{GC}- \xk\right)^T u\right|
% \ge \kappa_f \kappa_{\chi}  \min\left\{ \frac{\kappa_{\chi}}{\hfb}, 1 \right\} \dk^2 - \delta \chik\dk^2 \\
% \ge \left(\kappa_f \kappa_{\chi}  \min\left\{ \frac{\kappa_{\chi}}{\hfb}, 1 \right\} - \delta \kappa_{\chi}\right)\dk^2
% = \frac 1 2 \kappa_f \kappa_{\chi}  \min\left\{ \frac{\kappa_{\chi}}{\hfb}, 1 \right\}\dk^2
% \begin{align*}
% \left(-\gk\right)^T\left(v - \xk\right) = \left(-\gk\right)^T\left(u_{GC} - \xk\right) -  \left(-\gk\right)^T\left(u_{GC} - v\right) \\
% \ge \left(-\gk\right)^T\left(u_{GC} - \xk\right) -  \delta \left\|\gk\right \|  \left|\left(u_{GC}- \xk\right)^T u\right| \\
% \ge \left(-\gk\right)^T\left(u_{GC} - \xk\right) -  \delta \left\|\gk\right \|  \left|\left(u_{GC}- \xk\right)^T u\right| \\
% \end{align*}
