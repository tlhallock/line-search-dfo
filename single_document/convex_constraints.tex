...
\cite{Conn:2000:TM:357813} shows there exists $u_{GC}$ called the \emph{generalized Cauchy point} which satisfies this condition.
...
\begin{comment}
Coimpare two different trust region subprblems.
\end{comment}
