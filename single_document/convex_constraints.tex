...
Let $A_1$ be an $m \times n$ matrix and $h_0 > 0$ be given with $H(A_1) = h_0$.
Define 
\begin{align*}
...
Let $A_1$, $b_1 \in \Rm$; $p, \hat x, z_0, z_1, y \in \Rn$; and $r > 0$
be such that both
\begin{align*}\hat x \in 
\left\{x \in \Rn \bigg| A_2 x \le b_2 \right\} = 
\left\{x \in B_{\infty}(p, r) \bigg| A_1 x \le b_1 \right\}
\end{align*}
where
$b_2 = \begin{pmatrix} b_1 \\ p + re_{\pm} \end{pmatrix}$.
Define
