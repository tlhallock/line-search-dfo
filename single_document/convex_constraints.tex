...
u_{GC} = P_{\feasiblek\cap B_{\infty}\left(\dk\right)(\xk-\gk) \\
...
and
\begin{align}
\delta_2 = \kappa_f \kappa_{\chi} \min\left\{ \frac{\kappa_{\chi}}{1 + \maxhessian}, 1 \right\} \\
\delta = \min\left\{
\frac 1 {8\maxgrad(1 + \sqrt{n})} \delta_2,
\sqrt{\frac{\kappa_f \kappa_{\chi}}{32\maxhessian\left(1 + \sqrt{n}\right)^2} \min\left\{ \frac{\kappa_{\chi}}{1 + \maxhessian}, 1 \right\}}
...
Therefore, we only consider the case that $\zik \in B_{\infty}(\xk, 3\dk)$, and we will first prove that $v' = u_{GC} + \delta \dk^{p} \huk \in \capcones$.
