...
Let $\Omega$ be some open region containing $\feasible$.
...
\begin{assumptions}
Suppose that the assumptions for
\cref{lipschitz_gradients_assumption}, \cref{accuracy_is_satisfied}, \cref{delta_to_zero}, and \cref{contradiction_portion}
hold.
\end{assumptions}
...
If there exists an $\elb > 0$ such that $\ulb$ is infinite, 
...
Furthermore, if there is an $\elb > 0$ such that $\ulb$ is infinite, then for any $(k, l) \in \slb$, $k,l \ge k_0$, then $\forall i \in \activeindicesk$
\begin{align*}
...
and the assumptions for
\cref{accuracy_is_satisfied}, \cref{i_thought_i_proved_this_already}, \cref{contradiction_portion}, and \cref{delta_to_zero}
are satisfied.
\end{assumptions}
...
\begin{assumptions}
Suppose that \cref{bounded_gradients_lemma}, \cref{bounded_hessians_assumption}, \cref{lipschitz_gradients_assumption}, and \cref{minangleassumption_alt} hold.

Suppose that the assumptions for \cref{accuracy_is_satisfied}, \cref{bounded_projection_theorem}, \cref{delta_to_zero}, \cref{liminf_chi_to_zero}, and \cref{the_convergence_theorem} hold.
\end{assumptions}
...
\end{align*}
by \cref{single_star}.
By convexity of the constraints, $\feasible \subseteq \truefeasiblek$, so that
\begin{align*}
...
Using \cref{delta_to_zero}, \cref{accuracy_is_satisfied}, \cref{bounded_projection_theorem}, \cref{liminf_chi_to_zero}, 
and \cref{the_convergence_theorem},
...
% 
% \begin{theorem}
% Assume that \cref{bounded_level_sets} holds.
% \end{theorem}
% 
% \begin{proof}
% 
...
In this section, we discuss some progress towards replacing \cref{minangleassumption_alt} with \cref{minangleassumption_alt}.
...
Suppose that \cref{minangleassumption_alt}, 
% \cref{max_norm_assumption}, 
and \cref{lipschitz_gradients_assumption} hold.
