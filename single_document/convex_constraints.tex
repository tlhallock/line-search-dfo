...
\newcommand{\capcones}{{C_{\cap}}}
\newcommand{\linearization}{{C_{\bar \cap}}}
...
Because this is $B_{\infty}(\xk, \dk)$, we can satisfy the trust region constraints by including linear constraints of the form $\xk_i - \dk \le x_i \le \xk_i + \dk$.
...
\begin{algorithm}[H]
	...
	\item[\textbf{Step 1}] \textbf{(Construct ellipsoid)} \\
	   Construct the largest possible ellipsoid within $P_{\textrm{planes}} \cap B_{\infty}(\xk, \dk)$
    \end{itemize}
\end{algorithm}
...
The matrices $\hk$ are uniformly bounded, that is, there exists a constant $ \beta \ge 1 $ such that 
\begin{align}
\|\hk\| \le \beta - 1 \quad \forall k \ge 0.
\end{align}
\end{assumption}
...
\Longrightarrow -\alpha \dk^{\frac 1 2 }\|\gmcik\| + M \left(1 - \alpha \dk^{\frac 3 2 }\right)^2 \sqrt{n}\dk+ \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right) \le  0 \\
\Longrightarrow -\alpha \dk^{\frac 1 2 }\|\gmcik\|\left(-\frac{c_i(\xk)}{\|\gmcik\|}\right) + M \left(1 - \alpha \dk^{\frac 3 2 }\right)^2 \left(-\frac{c_i(\xk)}{\|\gmcik\|}\right)^2\\
...
\begin{align*}
0 &\ge& \alpha \dk^{\frac 1 2 } c_i(\xk) + M \frac {c_i(\xk)^2}{\|\gmcik\|^2}\left(1 - \alpha \dk^{\frac 1 2 }\right)^2 + \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 1 2 }\right)\frac{-c_i(\xk)}{\|\gmcik\|} & \\
&\ge& \alpha \dk^{\frac 1 2 } c_i(\xk) + M \frac {c_i(\xk)^2}{\|\gmcik\|^2}\left(1 - \alpha \dk^{\frac 1 2 }\right)^2 + \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 1 2 }\right)\frac{-c_i(\xk)}{\|\gmcik\|^2}\nu^T\gmcik & \\
&=& c_i(\xk)\left[1 - \left(1 - \alpha \dk^{\frac 1 2 }\right)\right] + M \frac {c_i(\xk)^2}{\|\gmcik\|^2}\left(1 - \alpha \dk^{\frac 1 2 }\right)^2 + \epsilon_g \dk^2\nu^T \left(\wik - \xk\right) & \\
&& + \epsilon_g \dk^2\nu^T \left(\wik - \xk\right) & \\
&=& c_i(\xk) + \left(\gmcik\right)^T\left(1 - \alpha \dk^{\frac 1 2 }\right)\frac{-c_i(\xk)}{\|\gmcik\|^2}\gmcik + M \left\|\left(1 - \alpha \dk^{\frac 1 2 }\right)\frac{-c_i(\xk)}{\|\gmcik\|^2}\gmcik\right\|^2 & \\
&=& c_i(\xk) + \left(\gmcik\right)^T\left(\wik - \xk\right)+ M \left\|\wik - \xk\right\|^2  + \epsilon_g \dk^2\nu^T \left(\wik - \xk\right) & \\
 & = & c_i(\xk) + \nabla c_i(\xk)^T\left(\wik - \xk \right) + M \left\|\wik - \xk\right\|^2 \ge c_i(\wik). &
\end{align*}

% \begin{align*}
% \alpha \dk^{\frac 3 2 } c_i(\xk) + M \frac {c_i(\xk)^2}{\|\gmcik\|^2}\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 + \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right)\frac{-c_i(\xk)}{\|\gmcik\|} \le 0\\
...
% \begin{align*}
% \alpha \dk^{\frac 3 2 } c_i(\xk) + M \frac {c_i(\xk)^2}{\|\gmcik\|^2}\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 + \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right)\frac{-c_i(\xk)}{\|\gmcik\|} \le 0\\
% \alpha \dk^{\frac 3 2 }\|\gmcik\| + M \frac {c_i(\xk)}{\|\gmcik\|}\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 - \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right) \ge 0\\
% M \dk\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 + \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right) \le \alpha \dk^{\frac 3 2 }\|\gmcik\| \\
% \end{align*}


% \alpha \dk^{\frac 3 2 } c_i(\xk) + M \dk^2\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 + \epsilon_g \dk^3 \left(1 - \alpha \dk^{\frac 3 2 }\right)\le 0\\
% \alpha c_i(\xk) + M \dk^{\frac 1 2}\left(1 - \alpha \dk^{\frac 3 2 }\right)^2 + \epsilon_g \dk^{\frac 3 2} \left(1 - \alpha \dk^{\frac 3 2 }\right)\le 0\\
% \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right) \le \alpha \dk^{\frac 3 2 }\|\gmcik\| + M \frac {c_i(\xk)}{\|\gmcik\|}\left(1 - \alpha \dk^{\frac 3 2 }\right)^2\\
% \epsilon_g \dk^2 \left(1 - \alpha \dk^{\frac 3 2 }\right) + M\sqrt{n} \dk \left(1 - \alpha \dk^{\frac 3 2 }\right)^2 \le \alpha \dk^{\frac 3 2 }\|\gmcik\|\\
% \epsilon_g \dk \left(1 - \alpha \dk^{\frac 3 2 }\right) + M\sqrt{n} \left(1 - \alpha \dk^{\frac 3 2 }\right)^2 \le \alpha \dk^{\frac 1 2 }\|\gmcik\|\\
% \epsilon_g \dk \left(1 - \alpha \dk^{\frac 3 2 }\right) + M\sqrt{n} \left(1 - 2\alpha \dk^{\frac 3 2 } + \alpha^2 \dk^{3}\right) \le \alpha \dk^{\frac 1 2 }\|\gmcik\|\\
...
% \Longrightarrow -s^T\gmcik \ge \frac 1 2 g_{\text{low}} \beta \dk^{\frac 1 2} + \epsilon_{g}\dk^2\nu^T s \\
\begin{align}
...
\Longrightarrow \frac{\epsilon_{g}}{\beta} \dk^{\frac 3 2} \le \|\gmcik\| - \frac 1 2 g_{\text{low}} \nonumber \\
\Longrightarrow -\|\gmcik\|s^T\hgik \ge \|\gmcik\|\beta\dk^{\frac 1 2} \ge \frac 1 2 g_{\text{low}} \beta \dk^{\frac 1 2} + \epsilon_{g}\dk^2  \nonumber \\
\Longrightarrow -s^T\gmcik \ge \frac 1 2 g_{\text{low}} \beta \dk^{\frac 1 2} + \epsilon_{g}\dk^2|\nu^T s| \nonumber \\ 
...
\begin{lemma}
We have that $\cap_{i \in \iik} \fik \cap B_{\infty}(\xk, \dk) \subseteq \feasible$ 
\end{lemma}
...
We have already shown that the cone $\fcki \cap B_{\infty}(\xk, \dk) \subset \feasible$.
...
\begin{align}
\trsfesset = \left\{x \in \Rn | x \in B_{\infty}(\xk, \dk)\cap \mcik(x) \le 0 \; \forall 1 \le i \le m\cap \|x - y \| \ge \trstol \forall y \in \bar \feasible\right\}
\end{align}
...
\begin{lemma}
There exists a constant $c$ such that if $s_1 \in \argmin_{\trsfesset}\mfk(s)$ and $s_2 \in \argmin_{\feasiblek \cap B_{\infty}(\xk, \dk)} \mfk(s)$, then $\mfk(s_1) \le c \mfk(s_2)$.
\end{lemma}
...
% \capcones = \{x\in\Rn | x \in B_{\infty}(\xk, \dk) \cap \left( \cap_i   \fik \right) \} 
% \end{align}
% and 
% $\linearization = \{x \in\Rn | x \in B_{\infty}(\xk, \dk) \cap\nabla \mcik(\xk)^Tx \le \mcik(\xk)\}$.
% 
% Let $u \in \linearization - \capcones$, and $u^{\star} = \textrm{P}_{\capcones}(u)$.
% 
% $t \wik + (1-t) (u - \wik)$
% $t \wik + (1-t) (u - \wik)$
% 
% 
% \begin{align*}
% \left(\wik - \xk\right)^T z = \left(\wik - \xk\right)^T\wik \\
% (u - z)^T\left(\wik - z\right) = 0 \\
% \|\wik + \frac{z - \wik}{\|z - \wik\|} - y \left(\xk -\wik\right)\|^2 = \beta^2 \\
% 1 + \beta^2 = \|\wik + \frac{z - \wik}{\|z - \wik\|} + y \left(\xk -\wik\right) - \wik \|^2 = \beta^2 \\
% 1 + \beta^2 = \left\|\wik + \frac{z - \wik}{\|z - \wik\|} + y \left(\xk -\wik\right) - \wik \right\|^2 \\
% 1 + \beta^2 = \left\|\frac{z - \wik}{\|z - \wik\|} + y \left(\xk -\wik\right)\right\|^2 \\
% = \left\|\frac{z - \wik}{\|z - \wik\|}\right\|^2 + y \left\|\left(\xk -\wik\right)\right\|^2 \\
% \Longrightarrow y = \frac{\beta^2}{\|\xk - \wik\|^2}
% \end{align*}
% 
% For what values of $t_1$ and $t_2$ does 
% \begin{align*}
% \frac{t_1}{\|u - \wik\|} u + \left(1-\frac{t_1}{{\|u - \wik\|}}\right) \wik  \\
% t_2 z    -\left(1-t_2\right)\wik \\
% t_3 \left( \wik + \frac{z - \wik}{\|z - \wik\|} +  \frac{\beta^2}{\|\xk - \wik\|^2} \left(\xk -\wik\right)   \right)    -\left(1-t_3\right)\wik \\
% \end{align*}
% 
% 
% 
% % \begin{align*}
% % \left \|\frac{t}{\|u - \wik\|} u + \left(1-\frac{t}{{\|u - \wik\|}}\right) \wik   -t \left( u + y \xk    \right)    -\left(1-t\right)\wik \right\| = \beta \\
% % \end{align*}
% 
% % \left \|\frac{1}{\|u - \wik\|} u + \left(1-\frac{1}{{\|u - \wik\|}}\right) \wik   -\frac{1}{\|u + y\xk - \wik\|}\left( u + y \xk    \right)    -\left(1-\frac{1}{\|u + y\xk - \wik\|}\right)\wik \right\|^2 = \beta^2 \\
% % \left \|u + \left(\|u - \wik\|-1\right) \wik    -\frac{1}{\|u + y\xk - \wik\|}\left( u + y \xk    \right)    -\left(1-\frac{1}{\|u + y\xk - \wik\|}\right)\wik \right\| = \beta \|u - \wik\|    \\
% % \left \|u + \left(\|u - \wik\|-1\right) \wik    - \left( u + y \xk    \right)    -\left(\|u + y\xk - \wik\|-1\right)\wik \right\| = \beta \|u - \wik\|  \|u + y\xk - \wik\|  \\
% 
% \begin{theorem}
% $\|u - u^{\star}\| \le  {\|u - \wik\|} \frac{\beta}{2} $
% \end{theorem}
% 
% 
% \begin{proof}
...
% \begin{proof}
% \begin{align*}
% \|u^{\star} - \xk\| \le \|u - \xk\| + \|u^{\star} - u\| \le \|u - \xk\| + {\|u - \wik\|} \frac{\beta}{2} \\
% \frac{\|u^{\star} - \xk\|}{\|u - \xk\|} \le 1 + \frac{{\|u - \wik\|} \frac{\beta}{2}}{\|u - \xk\|} \le 1+\frac{{\|u - \wik\|} \frac{\beta}{2}}{\|\xk - \wik\| - \|u - \wik\| \beta} \\
% = 1+\frac {\beta}{2}\frac{1}{\frac{\|\xk - \wik\|}{ \|u - \wik\| } - \beta}
% \end{align*}
% \end{proof}
...
\le (t_k L \|\sk\| + \kappa_{g}\dk) \|\sk\| + \frac 1 2 \beta \|\sk\|^2
\end{align*}
...
\begin{align*}
f(\xk) -  f(\xkpo) \ge \eta_1 \big (\mfk(\xk) - \mfk(\xk + \sk)\big ) \ge \eta_1 \kappa_f \chik \min\{\frac{\chik}{\beta}, \dk, 1\}\\
f(\xk) - f(\xkpo) \ge \eta_1\kappa_f\frac{\dk}{\oalpha}\min\{\frac{\dk}{\oalpha \beta}, \dk, 1\}
\end{align*}
...
\begin{align}
f(x^{(i)}) - f(x^{(i+1)}) \ge \eta\big ( \mfk(x^{(i)}) - \mfk(x^{(i)} + s^{(i)}) \big ) \ge \eta \kappa_f \chi_i \min\{\frac{\chi_{i}}{\beta}, \Delta_i, 1\} 
\end{align}
