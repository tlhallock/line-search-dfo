...
$\sk$ & is the trial point in iteration $k$, defined in \cref{buffered_trust_region_subproblem} \\
...
These & are things to create ellipsoids per iterate  \\ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
$\huk$ & is a feasible direction defined in \cref{define_u} \\
$\rotk$ & a rotation matrix defined in \cref{define_rotation} \\
$\zik$ & is a 0 of the linearized constraint, defined in \cref{define_z} \\
$\wik$ & is the vertex of a constraint's buffering cone, defined in \cref{define_w} \\
...
These & are constants used in the assumptions \\  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
These & are useful constants for the lemmas \\  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
These & are global algorithm constants  \\  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
These & are used in the bounded projection section \\
...
These & are some other things in the introduction\\  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
